        ...
        >
          {({ values, errors, touched, handleChange, handleBlur, handleSubmit, isSubmitting }) => (
            <form onSubmit={handleSubmit}>
              <h1 className="text-3xl font-semibold mb-8 bg-gradient-to-r from-gradient-1 to-gradient-5 bg-clip-text text-transparent">Add Product</h1>
                ...
                <div className="col-span-1 md:col-span-1">
                  ...
                  <div className="mb-4">
                    <input
                      ...
                      onChange={handleChange}
                      onBlur={handleBlur}
                      value={values.no_of_pounds}
                      name="no_of_pounds"
                      
                      className="border border-gray-200 rounded-lg h-16 shadow-none pl-5 text-base w-full mb-4"
                      placeholder="Number of pounds"
                    />
                    {errors.no_of_pounds && touched.no_of_pounds && <p className="text-red-500 text-left">{errors.no_of_pounds}</p>}
                  </div>
                  <div className="mb-4">
                    <input
                      type="text"
